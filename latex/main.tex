...
Die DARPA Urban Challenge ist ein Rennen zwischen autonomen Fahrzeugen, welches im Jahre 2007 von der \ac{DARPA} ausgetragen wurde. 
Das Rennen fand in bebautem Gebiet einer verlassenen Kaserne des ehemaligen Air Force-Stützpunktes George Air Force Base statt, die Karte kann ist in \cref{darpa_map} zu sehen.

\begin{figure}[!ht]
%\begin{center}
\caption{\acs{DARPA} Urban Challenge Map \footnote{\url{http://rsta.royalsocietypublishing.org/content/368/1928/4649}}}
...
Für Das Simalations Scenario wurde eine einfacher kleiner Kresiverkehr mit einem Außendurchmesser von 26m designt, da dieser auf grund seiner größe das interessanteste Objekt ist.
