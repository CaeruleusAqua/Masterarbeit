...
Aus diesem Vorgefilterten Messwerten werden nun für einen RANSAC drei zufällig herausgesucht.
...
Zum Planefitting einer be ne wird üblicherweise eine SVD (Singular Value Decomposition)  \cite{Nurunnabi2012,Ram2007,Soderkvist2009}.
SVD hat eine Komplexität von $\mathcal{O}(\min\{mn^2, m^2n\}$ \cite{Holmes2007}, da das Planefitting innehalb 
des RANSAC's sehr häufig mit einer großen Anzahl an Punkten ausgeführt wird, führt das Ausführen des SVD innhalb des RANSAC zu einer sehr hohen laufzeit.
