...
Although this study is not representative, it is to be assumed that the number of small and miniature circuits in the inner-city limits is larger than that of the large roundabouts,
...
\begin{tikzpicture}
  ...
  \node[rotate=90, left] at (-1.0cm,6cm) {Accidents per 1 million cars}; %Säulenbeschriftung
  \foreach \x/\y/\country in {0.5/0.56/Mini Roundabout,  %\x ist Anfang der Säulen
                              2/0.53/Smal Roundabout,  %\y ist Höhe der Säulen
                              3.5/1.14/Two-lane Passable,
...
\begin{tikzpicture}
  ...
  \foreach \x/\y/\value/\country in {0.5/1.95/3.9/Mini Roundabout,  %\x ist Anfang der Säulen
                              2/1.55/3.1/Smal Roundabout,  %\y ist Höhe der Säulen
                              3.5/4.7/9.4/Two-lane Passable,
