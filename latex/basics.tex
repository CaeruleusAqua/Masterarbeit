...
each processed data point is marked as processed. A range request is then made for each of these points. If the size of the returned neighborhood is lower than a certain limit (minPts), the point is marked as noise.
