...
Since autonomous driving is a very wide, indisciplinary subject, it is obvious. That not everything in this work can be dealt with.
Within the scope of darpah Chalenge many papers were published on this subject. What has not yet been explicitly discussed in these publications
is the handling of roundabouts, with atonomic vehicles. The aim of this thesis is therefore to analyze what sensor equipment is necessary for 
the observation of roundabouts, or whether the existing sensor equipment of the ReVeRe test vehicle Snowfox can be regarded as sufficient.
